...
public class TC_08_Verify_Test_Kit_Status_When_Only_Secondary_Result_Is_Uploaded_CLA_Not_Detected_GON_Unconfirmed_Reactive extends BaseClass {

	SH_Locators sh_locators;
	SH_Actions sh_actions;
	
	@Test
	public void TC_08_Verify_test_kit_status_when_only_secondary_result_is_uploaded_CLA_not_detected_GON_unconfirmed_reactive() throws Exception  {
		...
		sh_actions.TimsUrl();	
		sh_actions.markAsReceivedJourney("Lavender case 8.csv", "MBI-NIF-8596", "Barcode2");
