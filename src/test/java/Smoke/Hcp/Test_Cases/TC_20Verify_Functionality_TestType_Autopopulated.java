...
public class TC_20Verify_Functionality_TestType_Autopopulated extends BaseClass {
	// Declaration
    ...
    @Test
    public void Verify_Functionality_TestType_Autopopulated() throws InterruptedException, IOException
    {
		...
		patients_details_actions.functionality_Test_Name_Populated();
    }
