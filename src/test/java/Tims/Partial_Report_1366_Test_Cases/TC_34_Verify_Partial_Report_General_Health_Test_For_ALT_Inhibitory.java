...
public class TC_34_Verify_Partial_Report_General_Health_Test_For_ALT_Inhibitory extends BaseClass{
	...
	@Test
	public void TC_34_Verify_partial_report_general_health_test_for_ALT_inhibitory () throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedOfGeneralHealthProfileForPartialResultOfSoft1366("GeneralHealthProfilePrimary.csv", "GeneralHealthProfileSecondary.csv","854","958","458","854",NewValue,"458");
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForGeneralHealthProfile("ALT_Text");
}
