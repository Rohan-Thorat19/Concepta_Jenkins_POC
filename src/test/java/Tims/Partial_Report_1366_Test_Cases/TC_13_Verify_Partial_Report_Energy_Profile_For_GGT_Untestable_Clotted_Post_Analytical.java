...
public class TC_13_Verify_Partial_Report_Energy_Profile_For_GGT_Untestable_Clotted_Post_Analytical extends BaseClass{
	...
	@Test
	public void TC_13_Verify_partial_report_energy_profile_for_GGT_untestable_clotted_post_analytical() throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedForPartialResultOfSoft1366("EnergyProfilePrimary.csv", "EnergyProfileSecondary.csv","854","958","458","854","958",NewValue);
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForEnergyProfile("GGT_Text");
}
