...
public class PhleBotomist_Booking_Page_Action {
	...
	public void clickContinueMyReg() throws InterruptedException {
		...
		// WebButton.JsclickButton(phleBotomist_booking_page_locators.getContinueBtn(),
		// driver);
		WebWait.elementToBeClickable(driver, phleBotomist_booking_page_locators.get_txtCnfCnt(),
	...
	public void checkBootAppointmentIsPresent() {
		login_health_professional_actions.clickOnEnableLaterBtn();
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.get_boots_App_Menu(),
				Duration.ofSeconds(30));
		System.out.println(
				"Element: " + phleBotomist_booking_page_locators.get_boots_App_Menu().getText() + " is present");
		assertTrue(phleBotomist_booking_page_locators.get_boots_App_Menu().isDisplayed());
	...
	public void without_Selecting_Test_Type() throws InterruptedException {
		...
		// WebDropDown.selectByValue(driver,
		// phleBotomist_booking_page_locators.gettest_Type_dropDown(), "");
		WebButton.clickButton(phleBotomist_booking_page_locators.get_ConfirmBtn());
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.get_Required_Error_Msg(),
				Duration.ofSeconds(30));
	...
	public void verifyMandatoryFields() throws InterruptedException {
		...
		boolean allErrorsPresent = phleBotomist_booking_page_locators.get_txtEmptyDOB().isDisplayed()
		...
		System.out.println(
				"genderIdentificationError: " + phleBotomist_booking_page_locators.get_txtEmptyGender().getText());
	...
	public void selectFurtureDOB() throws InterruptedException {
		...
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.getAgeErrorMsg(),
				Duration.ofSeconds(20));
	...
	public void verifySexAtBirthSel() throws InterruptedException {
		...
		Actions actions = new Actions(driver);
		actions.scrollByAmount(0, 800).perform();
		WebWait.elementToBeClickable(driver, phleBotomist_booking_page_locators.getSelectGender(),
				Duration.ofSeconds(20));
		...
		try {
			...
			try {
				if (phleBotomist_booking_page_locators.get_txtEmptySexBirth().isDisplayed()) {
					System.out.println("genderIdentificationError: "
							+ phleBotomist_booking_page_locators.get_txtEmptySexBirth().getText());
				} else {
				...
				System.out
						.println("sexAtBirthError: 'Sex at Birth is required' element is NOT present on the web page.");
				allErrorsPresent = false;
			}
			...
			ExtentManager.getTest().log(Status.PASS,
					"'Sex at Birth is required' element is NOT present on the web page.");
	...
	public void verifyGenderIdentification() throws InterruptedException {
		...
		Actions actions = new Actions(driver);
		actions.scrollByAmount(0, 800).perform();
		WebWait.elementToBeClickable(driver, phleBotomist_booking_page_locators.getSelectIdentifyGender(),
				Duration.ofSeconds(20));
		...
		try {
			...
			if (phleBotomist_booking_page_locators.get_txtEmptySexBirth().isDisplayed()) {
				System.out
						.println("genderError: " + phleBotomist_booking_page_locators.get_txtEmptySexBirth().getText());
			} else {
				System.out.println("Gender error message is not displayed (This is allowed).");
			}
			...
			try {
				if (phleBotomist_booking_page_locators.get_txtEmptyGender().isDisplayed()) {
					System.out.println("genderIdentificationError: "
							+ phleBotomist_booking_page_locators.get_txtEmptyGender().getText());
				} else {
					System.out.println("'Sex at Birth is required' error message is not displayed.");
					allErrorsPresent = false;
				}
				...
				System.out.println(
						"genderIdentificationError: 'You must indicate if you still identify with this gender' element is NOT present on the web page.");
				allErrorsPresent = false;
			}

			// Assert that all mandatory errors are present except for the Gender error
			Assert.assertFalse(allErrorsPresent,
					"'You must indicate if you still identify with this gender' is present on the web page.");
			System.out.println(
					"Assertion Passed: 'You must indicate if you still identify with this gender' element is NOT present on the web page.");
			ExtentManager.getTest().log(Status.PASS,
					"'You must indicate if you still identify with this gender' element is NOT present on the web page.");
	...
	public void confirm_Details_Form(String DOB, String boot_Reg_Mob) throws InterruptedException {
		...
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.get_details_cfrm_Msg(),
				Duration.ofSeconds(30));
	...
	public void verifyInvalidFields() throws InterruptedException, TimeoutException {
		checkbox_Validation();

		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.gettxtDOB(), Duration.ofSeconds(30));
		WebButton.JsclickButton(phleBotomist_booking_page_locators.gettxtDOB(), driver);
		WebTextBox.sendInputUpdate(phleBotomist_booking_page_locators.gettxtDOB(), "03031998");
		WebTextBox.sendInputUpdate(phleBotomist_booking_page_locators.gettxtMobNo(), "asrff");
		WebButton.JsclickButton(phleBotomist_booking_page_locators.getSelectGender(), driver);
		WebButton.JsclickButton(phleBotomist_booking_page_locators.getSelectIdentifyGender(), driver);
		Actions actions = new Actions(driver);
		actions.scrollByAmount(0, 800).perform();
		...
		try {
			WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.getTxtInvalidMobNumber(),
					Duration.ofSeconds(10));
			boolean status = phleBotomist_booking_page_locators.getTxtInvalidMobNumber().isDisplayed();
			String msgEnterValidMobNum = phleBotomist_booking_page_locators.getTxtInvalidMobNumber().getText();
			System.out.println("Error: " + msgEnterValidMobNum);
			Assert.assertTrue(status, "Error message is not displayed");
			ExtentManager.getTest().log(Status.PASS, "Error msg: " + msgEnterValidMobNum);

		} catch (Exception e) {

			// String errorMsg = "An error occurred during the validation of the 'Invalid
			// Mobile Number' field.";
	...
	public void health_Assessment_Form_Nav() throws InterruptedException {
		...
		if (!phleBotomist_booking_page_locators.get_assessment_steps().isEmpty()) {
			...
			assertTrue(!phleBotomist_booking_page_locators.get_assessment_steps().isEmpty());
		} else {
			// System.out.println("Health Assessment form is not opened");
			Assert.fail("Health Assessment form is not opened");
		}

	}

	public void verifyHealthAssessmentIsMandatory() throws InterruptedException {
		health_Assessment_Form_Nav();
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.get_btnHealthassessmentContinue(),
				Duration.ofSeconds(30));
		WebButton.JsclickButton(phleBotomist_booking_page_locators.get_btnHealthassessmentContinue(), driver);
		Actions actions = new Actions(driver);
		actions.scrollByAmount(0, 800).perform();
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.get_btnCnfCntHealthAssess(),
				Duration.ofSeconds(30));
		WebButton.JsclickButton(phleBotomist_booking_page_locators.get_btnCnfCntHealthAssess(), driver);
		List<WebElement> errorMessages = phleBotomist_booking_page_locators.get_form1_invalidFeedback();
		if (!errorMessages.isEmpty()) {
			...
			System.out.println("Health Assessment is mandatory");
			ExtentManager.getTest().log(Status.PASS, "Health Assessment is mandatory");
		} else {
			Assert.fail("No error messages found");
			System.out.println("Health Assessment is not mandatory");

		}

	}

	public void navToNextPageHAForm() throws InterruptedException {

			checkbox_Validation();
			confirm_Details_Form("03031998", "3333333333");
			WebButton.clickButton(phleBotomist_booking_page_locators.get_assessment_start_Btn());
			WebWait.elementToBeClickable(driver, phleBotomist_booking_page_locators.get_btnHealthassessmentContinue(),
					Duration.ofSeconds(20));
			WebButton.clickButton(phleBotomist_booking_page_locators.get_btnHealthassessmentContinue());
			boolean status = phleBotomist_booking_page_locators.get_txtHeightAndWeight().isDisplayed();

			assertTrue(status, "User did not navigate to next page after clicking on Continue");
			System.out.println("User navigated to next page");
			ExtentManager.getTest().log(Status.PASS, "Test passed: User navigated to next page");	
	}
	...
	public void cancel_Appointment() throws InterruptedException {
		...
		try {
			...
			// WebWait.elementToBeClickable(driver,
			// phleBotomist_booking_page_locators.getContinueBtn(), Duration.ofSeconds(20));
			Thread.sleep(2000);
			WebButton.clickButton(phleBotomist_booking_page_locators.getContinueBtn());
		} catch (Exception e) {
			// WebWait.elementToBeClickable(driver,
			// phleBotomist_booking_page_locators.get_cancel_Reg_Btn(),
			// Duration.ofSeconds(10));
			Thread.sleep(2000);
			WebButton.clickButton(phleBotomist_booking_page_locators.get_cancel_Reg_Btn());

			WebWait.elementToBeClickable(driver, phleBotomist_booking_page_locators.getreject_Cnfrm_Btn(),
					Duration.ofSeconds(20));
			WebButton.clickButton(phleBotomist_booking_page_locators.getreject_Cnfrm_Btn());

			WebWait.elementToBeClickable(driver, phleBotomist_booking_page_locators.getContinueBtn(),
					Duration.ofSeconds(20));
			WebButton.clickButton(phleBotomist_booking_page_locators.getContinueBtn());
	...
	public void Verify_Complete_Health_Assessment_Form_1(String Height, String Weight, String SmokeYes,
		...
		WebWait.visibilityOfElement(driver, phleBotomist_booking_page_locators.get_btnCnfCntHealthAssess(), Duration.ofSeconds(30));
