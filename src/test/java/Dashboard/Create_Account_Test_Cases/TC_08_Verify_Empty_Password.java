...
public class TC_08_Verify_Empty_Password extends BaseClass
{
	...
	@Test
	public void TC_08_Verify_error_for_empty_password() throws Exception
	{				
		create_account_actions = new Create_Account_Actions(getDriver());		
		create_account_actions.dashboardUrl();
		create_account_actions.emptyPassword();
    }
