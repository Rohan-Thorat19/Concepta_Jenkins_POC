...
public class TC_33VerifyRejectAppointementReflectsTheBarcodeAsError extends BaseClass {
	...
	// Declaration
		...
		@Test
		public void VerifyRejectAppointementReflectsTheBarcodeAsError() throws Exception
	    {
				...
				patients_details_actions.functionality_Reject_Appointment_Effect_To_Barcode_As_Error();
				tims_TC_For_HCP_Smoke_Actions = new Tims_TC_For_HCP_Smoke_Actions(getDriver());
				tims_TC_For_HCP_Smoke_Actions.login_Tims();
				tims_TC_For_HCP_Smoke_Actions.functionalityOfBarcodeError();
	    }		
