...
public class TC_27Verify_functionality_Final_Register_And_Confirmation extends BaseClass {
	// Declaration
	...
	@Test
	 public void Verify_functionality_Final_Register_And_Confirmation() throws InterruptedException, IOException
	 {
		...
		login_health_professional_actions.login_HCP();
			...
			patients_details_actions.functionality_Final_Register_And_Confirmation();			                         
