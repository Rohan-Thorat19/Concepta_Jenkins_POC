...
public class TC_30_TC_31_TC_32VerifyRejectionBarcodeOrder extends BaseClass {
	...
	// Declaration
		...
		@Test
		public void VerifyRejectionBarcodeOrder() throws Exception
	    {
				...
				patients_details_actions.functionality_Reject_Kit_But_Not_Effect_To_Customer();
