...
public class Create_test_kit_For_PL_Locators {

	public WebDriver driver;

	public Create_test_kit_For_PL_Locators(WebDriver driver) {
	...
	@FindBy(xpath = "(//input[@type='number'])[1]")
		...
		WebElement  Secondarybarcode;

		public WebElement  getsecondarybarcode() {
		...
		@FindBy(xpath = "//th[normalize-space()='Sub Type:']/following-sibling::td")
		WebElement  Subtype2;

		public WebElement  getSubtype2() {
			return Subtype2;
		}
}
