...
public class TC_01_Verify_Published_Test_Report_With_Full_Blood_Results_Energy_Profile extends BaseClass{
	...
	@Test
	public void TC_01_Verify_published_test_report_with_full_blood_results_energy_profile() throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedForPartialResultOfSoft1366("EnergyProfilePrimary.csv", "EnergyProfileSecondary.csv","854","958","458","854","958","458");
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForEnergyProfileForAllOptionsEnergyProfile();
}
