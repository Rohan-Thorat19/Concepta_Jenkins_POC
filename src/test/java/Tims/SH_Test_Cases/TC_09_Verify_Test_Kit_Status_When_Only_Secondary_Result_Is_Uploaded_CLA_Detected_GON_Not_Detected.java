...
public class TC_09_Verify_Test_Kit_Status_When_Only_Secondary_Result_Is_Uploaded_CLA_Detected_GON_Not_Detected extends BaseClass{

	SH_Locators sh_locators;
	SH_Actions sh_actions;
	
	@Test
	public void TC_09_Verify_test_kit_status_when_only_secondary_result_is_uploaded_CLA_detected_GON_not_detected() throws Exception  {
		...
		sh_actions.TimsUrl();	
		sh_actions.markAsReceivedJourney("Lavender case 9.csv", "MBU-VWH-4237", "Barcode2");
