...
public class TC_04_Verify_Mandatory_Fields extends BaseClass
{
	...
	@Test
	public void TC_04_Verify_mandatory_fields() throws Exception
	{				
		create_account_actions = new Create_Account_Actions(getDriver());		
		create_account_actions.dashboardUrl();
		create_account_actions.checkMandatoryFeilds();
    }
