...
public class TC_28Verify_Email_Confirmation extends BaseClass {
	// Declaration
	...
	@Test
	 public void Verify_Email_Confirmation() throws Exception
	 {
		...
		patients_details_actions.ReadGmail("Confirmation Email");
	 }
