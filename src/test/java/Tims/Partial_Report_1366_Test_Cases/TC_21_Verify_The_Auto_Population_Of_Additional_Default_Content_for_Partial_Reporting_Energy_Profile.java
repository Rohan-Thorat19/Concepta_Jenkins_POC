...
public class TC_21_Verify_The_Auto_Population_Of_Additional_Default_Content_for_Partial_Reporting_Energy_Profile extends BaseClass{
	...
	@Test
	public void TC_21_Verify_the_auto_population_of_additional_default_content_for_partial_reporting_energy_profile () throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedForPartialResultOfSoft1366("EnergyProfilePrimary.csv", "EnergyProfileSecondary.csv","854","958","458",NewValue,"958",NewValue);
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.autoPopulationOfAdditionalDefaultContent();
}
