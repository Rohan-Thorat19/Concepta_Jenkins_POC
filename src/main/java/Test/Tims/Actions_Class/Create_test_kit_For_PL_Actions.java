...
public class Create_test_kit_For_PL_Actions {
	public WebDriver driver;
	Create_test_kit_For_PL_Locators create_test_kit_Locators;
	 private String barcode;
	 private String barcode1;
	 
	public Create_test_kit_For_PL_Actions(WebDriver driver) {
		this.driver = driver;
		create_test_kit_Locators = new Create_test_kit_For_PL_Locators(driver);
	}
	...
	public void Select_Subtype_For_PL() {
		
		WebWait.elementToBeClickable(driver, create_test_kit_Locators.getSubtype1(), Duration.ofSeconds(30));
	    WebDropDown.selectByText(create_test_kit_Locators.getSubtype1(), "phlebotomy lavender");
	}
	
	public void Select_Subtype_For_PG() {
	...
	public void getBarcodeTextPG() throws InterruptedException {
		Thread.sleep(3000);
	...
	public void getBarcodeTextPL() throws InterruptedException {
		Thread.sleep(3000);
		WebScreenshot.TakeScreenShot(driver, "Barcode Batch");
	    WebElement barcodeElement = create_test_kit_Locators.getBarcodeList();  
	    barcode1 = barcodeElement.getText();  // Extract and store text
	    System.out.println("Stored Barcode: " + barcode1);  
	     // Reuse by returning
	}
	...
	public void Selectsecondary() throws InterruptedException {
		WebWait.visibilityOfElement(driver, create_test_kit_Locators.getsecondarybarcode(), Duration.ofSeconds(30));
		Thread.sleep(5000);
		WebTextBox.sendInputUpdate(create_test_kit_Locators.getsecondarybarcode(), barcode1);
	}
	...
	public void Create_Phlebotom_phlebotomy_lavender_barcode_batches() throws InterruptedException {
		clickOn_Enable_Later();
		clickOn_Barcode_batches();
		clickOn_Create_blood_batch();
		Select_type();
		Select_Subtype_For_PL();
		Select_Count();
		clickOn_Save();
	...
	public void Test_Kit_Creation_PL() throws InterruptedException {
		clickOn_Enable_Later();
		clickOn_Barcode_batches();
		clickOn_Create_blood_batch();
		Select_type();
		Select_Subtype_For_PG();
		Select_Count();
		clickOn_Save();		
		Select_Barcode();
		getBarcodeTextPG();
