...
public class TC_14_Verify_Partial_Report_Energy_Profile_For_ALP_Untestable_Insufficient_Sample_Receipt extends BaseClass{
	...
	@Test
	public void TC_14_Verify_partial_report_energy_profile_for_ALP_untestable_insufficient_sample_receipt() throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedForPartialResultOfSoft1366("EnergyProfilePrimary.csv", "EnergyProfileSecondary.csv","854","958","458",NewValue,"958","458");
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForEnergyProfile("ALP_Text");
}
