...
public class TC_36_Verify_Partial_Report_General_Health_Test_For_ALP_Untestable_Insufficient_Sample_Receipt extends BaseClass{
	...
	@Test
	public void TC_36_Verify_partial_report_general_health_test_for_ALP_untestable_insufficient_sample_receipt () throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedOfGeneralHealthProfileForPartialResultOfSoft1366("GeneralHealthProfilePrimary.csv", "GeneralHealthProfileSecondary.csv","854","958","458",NewValue,"958","458");
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForGeneralHealthProfile("ALP_Text");
}
