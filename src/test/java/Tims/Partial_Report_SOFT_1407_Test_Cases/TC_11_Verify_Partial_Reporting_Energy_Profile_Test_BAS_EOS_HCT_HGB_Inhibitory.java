...
public class TC_11_Verify_Partial_Reporting_Energy_Profile_Test_BAS_EOS_HCT_HGB_Inhibitory extends BaseClass {
	...
	@Test
	public void TC_11_Verify_partial_reporting_energy_profile_test_BAS_EOS_HCT_HGB_inhibitory() throws InterruptedException, IOException {
		soft_1407_partial_report_actions = new SOFT_1407_Partial_Report_Actions(getDriver());
		soft_1407_partial_report_actions.partialReportTC11();
	}
}
