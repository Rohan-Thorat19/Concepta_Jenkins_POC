...
public class TC_07_Verify_Empty_Email extends BaseClass
{
	...
	@Test
	public void TC_07_Verify_error_for_empty_email() throws Exception
	{				
		create_account_actions = new Create_Account_Actions(getDriver());		
		create_account_actions.dashboardUrl();
		create_account_actions.emptyEmail();
    }
