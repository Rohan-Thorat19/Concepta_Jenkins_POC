...
public class TC_14_Verify_customer_can_select_new_test_type_from_dropdown extends BaseClass {
	
	Login_Action Login_action;
	PhleBotomist_Booking_Page_Action phleBotomist_booking_page_action;
	
	@Test
	public void Verify_customer_can_select_new_test_type_from_dropdown_SOFT_685_F1() throws IOException, InterruptedException {
		...
		phleBotomist_booking_page_action.selectTestType();
	}
}
