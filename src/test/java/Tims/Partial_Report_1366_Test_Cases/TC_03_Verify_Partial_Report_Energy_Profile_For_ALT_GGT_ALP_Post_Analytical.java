...
public class TC_03_Verify_Partial_Report_Energy_Profile_For_ALT_GGT_ALP_Post_Analytical extends BaseClass{
	...
	@Test
	public void TC_03_Verify_partial_report_energy_profile_for_ALT_GGT_ALP_post_analytical() throws Exception
	{
		String NewValue = "Untestable – Insufficient (post-analytical)";
		...
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForEnergyProfile("ALT_GGT_ALP_post_analytical");
}
