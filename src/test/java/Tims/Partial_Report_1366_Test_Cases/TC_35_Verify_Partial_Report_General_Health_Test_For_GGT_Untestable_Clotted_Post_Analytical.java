...
public class TC_35_Verify_Partial_Report_General_Health_Test_For_GGT_Untestable_Clotted_Post_Analytical extends BaseClass{
	...
	@Test
	public void TC_35_Verify_partial_report_general_health_test_for_GGT_untestable_clotted_post_analytical () throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedOfGeneralHealthProfileForPartialResultOfSoft1366("GeneralHealthProfilePrimary.csv", "GeneralHealthProfileSecondary.csv","854","958","458","854","958",NewValue);
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForGeneralHealthProfile("GGT_Text");
}
