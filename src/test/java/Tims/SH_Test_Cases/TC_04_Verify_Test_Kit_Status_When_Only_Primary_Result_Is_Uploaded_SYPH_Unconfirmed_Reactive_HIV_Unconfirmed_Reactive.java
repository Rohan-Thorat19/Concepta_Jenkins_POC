...
public class TC_04_Verify_Test_Kit_Status_When_Only_Primary_Result_Is_Uploaded_SYPH_Unconfirmed_Reactive_HIV_Unconfirmed_Reactive extends BaseClass{

	SH_Locators sh_locators;
	SH_Actions sh_actions;
	
	@Test
	public void TC_04_Verify_test_kit_status_when_only_primary_result_is_uploaded_SYPH_Unconfirmed_Reactive_HIV_Unconfirmed_Reactive() throws Exception  {
		...
		sh_actions.TimsUrl();	
		sh_actions.markAsReceivedJourney("Gold case 4.csv", "MGQ-DDO-2959", "Barcode1");
