...
public class TC_12_Verify_Partial_Report_Energy_Profile_For_ALT_Inhibitory extends BaseClass{
	...
	@Test
	public void TC_12_Verify_partial_report_energy_profile_for_ALT_inhibitory() throws Exception
	{
		...
		activate_test_kit_Actions.dashboardUrlOfTims();
		activate_test_kit_Actions.markAsReceivedBothResultsUploadedForPartialResultOfSoft1366("EnergyProfilePrimary.csv", "EnergyProfileSecondary.csv","854","958","458","854",NewValue,"458");
		sOFT_1366_Partial_Report_Actions = new SOFT_1366_Partial_Report_Actions(getDriver());	
		sOFT_1366_Partial_Report_Actions.publishKitAndCheckStatusForEnergyProfile("ALT_Text");
}
